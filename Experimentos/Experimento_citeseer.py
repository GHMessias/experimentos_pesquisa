...
for rate in positive_rate:
    for i in range(10):
        ...
        for algorithm in algorithms_citeseer:
            ...
            algorithms_citeseer[algorithm].train()
            if algorithm in auto_inference_algorithms:
                RN = algorithms_citeseer[algorithm].negative_inference()
            else:
                RN = algorithms_citeseer[algorithm].negative_inference(num_neg)
            end_time = time.time()
            ...
            df.to_csv('Resultados/dataframe_citeseer.csv', index = False)
