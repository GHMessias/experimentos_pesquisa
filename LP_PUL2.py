...
class LP_PUL:
    ...
    def train(self):
        self.distance_vector = np.zeros(len(self.unlabeled) + len(self.positives))
        ...
        for p in self.positives:
            ...
            d = np.zeros(len(self.unlabeled))

        
        self.distance_vector = self.distance_vector / len(self.positives)
